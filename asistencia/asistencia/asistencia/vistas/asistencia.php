...
<html>
  <head>
    ...
    <title>Sarita  | Control Asistencia</title>
...
<?php 
 //include '../ajax/asistencia.php' ?>
  ...
  <div class="lockscreen-logo">
    <a href="#"><b>Helados Sarita</a>
  </div>
  <!-- User name -->
  <div class="lockscreen-name">CONTROL ASISTENCIA</div>
  ...
  <div class="lockscreen-item">
    ...
    <form  action="" class="lockscreen-credentials" name="formulario" id="formulario" method="POST">
      <div class="input-group">
        <input type="password" class="form-control" name="codigo_persona" id="codigo_persona" placeholder="ID de asistencia" autofocus >
